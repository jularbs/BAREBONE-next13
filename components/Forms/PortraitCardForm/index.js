...
const PortraitCardForm = ({ label, location, group }) => {
  ...
  //TODOS: use in useEffect function and create function to fetch data
        ...
        <td className="d-flex justify-content-end">
          <Button
            ...
            onClick={() => {
              ...
              setDeleteHandler({ key: item.name, input: "" });
        ...
        <ModalBody className="py-0">
          <FormGroup className="mb-0">
            <span className="text-sm">
              Type "{deleteHandler.key}" to permanently delete portrait card.
            </span>
            <Input
              placeholder=""
              type="text"
